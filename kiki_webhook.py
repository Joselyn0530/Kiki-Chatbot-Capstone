...
def webhook():
    ...
    if intent_display_name == 'set.reminder':
        ...
        # user_client_id extraction and check REMOVED
        # Reminders will no longer be user-specific in Firestore
        ...
        try:
            ...
            reminder_data = {
                ...
                # 'user_client_id': user_client_id, # user_client_id field REMOVED
                'status': 'pending',
